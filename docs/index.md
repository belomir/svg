...
[фильтры (turbulence с анимацией, наложенная как displacemap 2)](https://rawgit.com/belomir/svg/master/src/misc/turb72.svg)

[графы drag'n'drop (принимает аргументы в url типа ?d=A:C,D;B:C,D)](https://rawgit.com/belomir/svg/master/src/misc/drag'n'drop.svg??d=A:C,D;B:C,D)
...
[реалстичная тень в стиле material design (пообновляйте страницу)](https://rawgit.com/belomir/svg/master/src/misc/md.svg)
...
[интегрирование (интерактивно, параметры url: m=метод (left, right, mid, max, min, trap), n=количество отрезков; например ?m=trap&n=5)](https://rawgit.com/belomir/svg/master/src/misc/int_common.svg)

[y=kx+b (k и b — параметры url, например ?k=-2&b=3)](https://rawgit.com/belomir/svg/master/src/misc/line.svg)
